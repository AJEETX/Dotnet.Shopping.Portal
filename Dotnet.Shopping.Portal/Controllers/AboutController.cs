...
namespace Dotnet.Shopping.Portal.Controllers
{
    public class AboutController : Controller
    {
        ...
        public AboutController(IProductService productService, IMapper mapper)
        {
            _mapper = mapper;
        ...
        {
            var page = _productService.GetAllProducts().FirstOrDefault(p => p.Name.ToLower() == "about");
            var pageModel = _mapper.Map<Product, ProductCreateOrUpdateModel>(page);
