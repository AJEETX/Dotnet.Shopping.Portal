    ...
    public class ManufacturerController : AdminController
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            foreach (var manufacturer in manufacturerEntities)
            {
                ...
                {
                    var image = await _imageManagerService.GetImageById(Guid.Parse(manufacturer.MainImage));
                    if (image != null)
        ...
        public async Task<IActionResult> Edit(Guid? id, string ActiveTab)
        {
            if (id == null)
                return RedirectToAction("List");
            ...
            {
                var image = await _imageManagerService.GetImageById(Guid.Parse(manufacturerEntity.MainImage));
                if (image != null)
